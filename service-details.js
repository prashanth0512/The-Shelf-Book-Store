document.addEventListener('DOMContentLoaded', () => {
  ...
  // Fallback to default if matching service is not found
  ...
  const injectContent = () => {
    ...
    // 4. Value Benefits Cards Elements
  ...
  const savedTheme = localStorage.getItem('bookstore-theme') || 'light'; // dark is the bookstore variables default
